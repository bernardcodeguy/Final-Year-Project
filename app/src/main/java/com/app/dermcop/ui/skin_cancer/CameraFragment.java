...
import com.app.dermcop.ui.skin_cancer.ui.PreviewOverlay;
...
public class CameraFragment extends Fragment {
    ...
    private static final String[] GALLERY_PERMISSION = new String[]{Manifest.permission.READ_EXTERNAL_STORAGE};
...
//        View flashScreen = view.findViewById(R.id.imageFlash);
    ...
    private Bitmap cropBitmap(Bitmap bitmap) {
        ...
        //Toast.makeText(getContext(), x+y+newSize, Toast.LENGTH_LONG).show();
